...
export function VideoAutoPanel({ apiKey }: { apiKey: string }) {
  ...
  return (
    <div>
      <div className="mb-2 text-sm text-gray-500">
        Method: <code>gemini.videoUnderstanding.analyzeVideoAuto(filePart, prompt)</code>
      </div>
      <div className="mb-2">
        <label className="block text-xs text-gray-500 mb-1">Select Uploaded Video:</label>
        <select
      ...
      {response && (
        <div className="mt-4 bg-gray-100 p-2 rounded">
          <div className="font-bold mb-1">Video Output:</div>
